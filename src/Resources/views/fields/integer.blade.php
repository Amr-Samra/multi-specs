<div class="form-group xxs-pt-40 clearfix">
    ...
    <div class="col-xs-10 col-sm-7">
        {!! Form::input('number',"specs[{$spec->id}]", (isset($spec->pivot) ? $spec->pivot->value : null), ['class' => 'form-control font-droidkufi xxs-pt-10 xxs-pb-30 xxs-pr-0 text-right lang-ltr','placeholder'=>$spec->default]) !!}
